  ...
  return (
    <div className="space-y-6">
      ...
      <section className="card">
        <h2 className="mb-3 text-2xl font-semibold">Кауце (депозит)</h2>
        <p className="text-slate-700 mb-3">
          При выдаче инструмента берётся возвратный депозит — кауце. Его размер зависит от стоимости позиции
          и указан на странице каждого товара.
        </p>
        <ul className="space-y-2 text-slate-700 text-sm">
          <li className="flex items-start gap-2">
            <span className="text-green-700 font-bold mt-0.5">✓</span>
            <span>Кауце оплачивается удобным для вас способом — наличными, переводом или картой.</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-green-700 font-bold mt-0.5">✓</span>
            <span>После возврата и проверки инструмента кауце возвращается тем же платёжным способом.</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-green-700 font-bold mt-0.5">✓</span>
          ...
          <li className="flex items-start gap-2">
            ...
            <span>Кауце не возвращается в случае поломки или утери имущества по вине клиента.</span>
          </li>
        </ul>
      </section>
      ...
      <section className="card">
        ...
        <ol className="list-decimal space-y-2 pl-5 text-slate-700 text-sm">
          ...
          <li>Для оформления аренды необходимы контактные данные и оплата кауце.</li>
        </ol>
      </section>
    </div>
  )
